...
const handlers: Record<string, Handler> = {
	...
	update_global_config: config.update_global_config,
	set_last_project: config.set_last_project,
	resolve_config: config.resolve_config,
	create_agent_profile: config.create_agent_profile,
	update_agent_profile: config.update_agent_profile,
	delete_agent_profile: config.delete_agent_profile,
	get_status_group_defaults: config.get_status_group_defaults,
	update_status_group_defaults: config.update_status_group_defaults,
